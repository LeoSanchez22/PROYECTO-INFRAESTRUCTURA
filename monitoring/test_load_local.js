...
// Helper function to simulate metrics logging
...
function simulateHttpRequest() {
  ...
  if (Math.random() < 0.9) {
    ...
    logMetric('api', 'requests', 1, { method, statusCode });
  }
}
...
function runSimulations() {
  colorLog(colors.bright, '🚀 [LOAD GENERATOR]', 'Starting test load generator in LOCAL mode');
  colorLog(colors.bright, '🚀 [LOAD GENERATOR]', 'Output will be displayed in console only');
